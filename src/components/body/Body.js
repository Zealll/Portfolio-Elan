        ...
        <div className='body-container'>
            ...
            <div className='algo project'>
                    ...
                    <div className='description-container'>
                        <p className='first-p'>Tool for visualizing some of the most common Search Algorithms (ex: Dijkstra, BFS, DFS, etc.). This tool is implemented in React.js. It's purpose is to help beginer programmers visualize common search algorithms for better and easier understanding.</p>
